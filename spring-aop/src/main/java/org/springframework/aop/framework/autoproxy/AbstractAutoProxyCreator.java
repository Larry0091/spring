...
public abstract class AbstractAutoProxyCreator extends ProxyProcessorSupport
	...
	protected TargetSource getCustomTargetSource(Class<?> beanClass, String beanName) {
		...
		if (customTargetSourceCreators != null && beanFactory != null && beanFactory.containsBean(beanName)) {
			for (TargetSourceCreator tsc : customTargetSourceCreators) {
	...
	protected boolean shouldProxyTargetClass(Class<?> beanClass, @Nullable String beanName) {
		return (beanFactory instanceof ConfigurableListableBeanFactory && AutoProxyUtils
				.shouldProxyTargetClass((ConfigurableListableBeanFactory) beanFactory, beanName));
	}
