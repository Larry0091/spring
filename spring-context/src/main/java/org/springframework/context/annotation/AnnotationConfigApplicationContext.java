...
public class AnnotationConfigApplicationContext extends GenericApplicationContext implements AnnotationConfigRegistry {
	...
	public AnnotationConfigApplicationContext() {
		...
		/**
		 * 可以用来扫描包或者类，继而转换成bd
		 * 但实际上扫描包的工作不是scanner这个对象来完成的
		 * spring自己new了一个ClassPathBeanDefinitionScanner
		 * 这里的scanner只是程序员外部调用的AnnotationConfigApplicationContext
		 */
...
//		setAllowCircularReferences(false);
	...
	public <T> void registerBean(@Nullable String beanName, Class<T> beanClass, Object... constructorArguments) {
		reader.doRegisterBean(beanClass, null, beanName, null, bd -> {
